...
(function() {
  var BusRouteLayer, BusStopLayer, DistanceLayer, Layer, RentalsLayer, busRouteLayer, busStopLayer, distanceLayer, loadBusRoutes, loadRentals, map, polymaps, recordEvent, recordOutboundLink, rentalLayer, setVariable, setupDistanceSlider, setupPriceSlider, setupRoomsSlider, setupSharedCheckbox, toggleClick,
    ...
    RentalsLayer = (function(_super) {
      ...
      RentalsLayer.prototype.setListingDisplay = function(rental) {
        ...
        listings = (function() {
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            suite = _ref[_i];
            _results.push("<li>" + suite.bedrooms + " bedroom: " + (suite.price && suite.price > 0 ? "$" + suite.price : "Unknown") + "</li>");
          }
          return _results;
        })();
        output = "";
